...
public class SelectExpandJavaMapperMethodGenerator extends AbstractJavaMapperMethodGenerator {
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        addSelectOneByExample(interfaze);
    }

    private void addSelectOneByExample(Interface interfaze) {
        // 先创建import对象
        ...
        // 为方法添加参数，变量名称record
        method.addParameter(new Parameter(parameterType, "example")); //$NON-NLS-1$
