...
import com.github.lany192.mybatis.generator.template.file.GenerateByListTemplateFile;
import com.github.lany192.mybatis.generator.template.file.GenerateByTemplateFile;
import com.github.lany192.mybatis.generator.template.formatter.ListTemplateFormatter;
...
import com.github.lany192.mybatis.generator.template.model.TableColumnBuilder;
...
public class TemplateFilePlugin extends PluginAdapter {
     ...
     * 默认的模板格式化类
     */
    public static final String DEFAULT_TEMPLATEFORMATTER = "com.github.lany192.mybatis.generator.formatter.FreemarkerTemplateFormatter";
    /**
     * 单个文件模式
     */
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        if ("TRUE".equalsIgnoreCase(singleMode)) {
            files.add(new GenerateByTemplateFile(tableClass, (TemplateFormatter) templateFormatter, properties, targetProject, targetPackage, fileName, templateContent));
        } else {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles() {
        ...
        if (cacheTables != null && cacheTables.size() > 0) {
            files.add(new GenerateByListTemplateFile(cacheTables, (ListTemplateFormatter) templateFormatter, properties, targetProject, targetPackage, fileName, templateContent));
        }
        return files;
    }
